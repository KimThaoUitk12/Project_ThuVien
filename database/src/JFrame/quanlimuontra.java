...
//        int col = jTable1.columnAtPoint(evt.getPoint());
    ...
    private void initComponents() {
        ...
        BTraTien = new javax.swing.JButton();
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel4Layout.createSequentialGroup()
                                        .addComponent(BTraTien, javax.swing.GroupLayout.PREFERRED_SIZE, 70, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(0, 0, Short.MAX_VALUE))))))
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGap(24, 24, 24)
    ...
    private javax.swing.JButton BTraTien;
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource().equals(BKiemTraDocGia)) {
           ...
           if((LoadDG(this.TextMadocGia.getText()))){
               this.LBState.setVisible(false);
               dangmuon=getSoSachDangMuon(this.TextMadocGia.getText());
               han=getSoSachQuaHan(this.TextMadocGia.getText());
               this.TextTenDocGia.setText(LayTenDocGia(this.TextMadocGia.getText()));
...
//            }
        ...
        if (ae.getSource().equals(BTaoMaMuon)) {
            this.TextMaPhieuMuon.setText(TaoMa("phieumuon"));
        }
...
//                }
//            }
            if(CheckDanhSachTam(this.TableMuonTam,count,this.TextMaSach.getText())){
